...
abstract contract GovernorVoteTracker is Governor {
    ...
    function _castVote(
        ...
        // Track voter info
        _voterInfo[proposalId][account] = VoterInfo({
            voted: true,
            support: support,
            weight: weight
        });
     ...
     */
    function getVoterInfo(uint256 proposalId, address voter) public view returns (bool voted, uint8 support, uint256 weight) {
